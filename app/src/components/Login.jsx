        ...
        <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-2xl p-8 border border-transparent dark:border-slate-700">
          ...
          <div className="mt-6 pt-5 border-t border-gray-100 dark:border-slate-700">
            ...
            <div className="grid grid-cols-2 gap-2">
              ...
              <button onClick={() => fill('tester', 'stress2026')}
                className="text-xs px-3 py-2 bg-indigo-100 dark:bg-indigo-900/30 hover:bg-indigo-200 dark:hover:bg-indigo-900/50 rounded-lg text-indigo-700 dark:text-indigo-300 transition-colors border border-indigo-200 dark:border-indigo-800 font-bold col-span-2">
                System Tester (Demo)
              </button>
            </div>
          </div>
